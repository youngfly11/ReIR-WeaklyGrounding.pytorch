...
class FLICKR30KEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        for phrase_ids, phrase_type, pred_boxes, pred_sim, targets, precomp_boxes, img_sent_id, topk_pred_sim, topk_fusion_pred_sim, topk_pred_box, topk_fusion_pred_boxes \
                in zip(all_phrase_ids, all_phrase_type, all_pred_boxes, all_pred_similarity, all_targets, all_precomp_boxes,
                       all_img_sent_ids, all_topk_pred_similarity, all_topk_fusion_similarity,all_topk_pred_boxes,all_topk_fusion_pred_boxes):
